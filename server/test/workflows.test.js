describe('Listing Workflows', function() {
  ...
  it('should list open workflows', function() {
    ...
    return request()
      .get('/api/domain/canary/workflow/open?startTime=2017-11-12T12:00:00Z&endTime=2017-11-13T14:30:00Z')
      .expect(200)
  ...
  it('should list closed workflows', function() {
    ...
    return request()
      .get('/api/domain/canary/workflow/closed?startTime=2017-11-12T12:00:00Z&endTime=2017-11-13T14:30:00Z')
      .expect(200)
      .expect('Content-Type', /json/)
      .expect({
        executions: [demoExecJson],
  ...
  it('should forward the next page token along', function() {
    ...
    return request()
      .get('/api/domain/canary/workflow/closed?startTime=2017-11-01&endTime=2017-11-13T22:27:17.551Z&nextPageToken=cGFnZTE=')
      .expect(200)
      .expect('Content-Type', /json/)
      .expect({
        executions: [],
  ...
  it('should return 404 if another state of workflows is queried', function() {
    return request()
      .get('/api/domain/canary/workflow/failed')
      .expect(404)
  })

  it('should return 400 if startTime or endTime are missing', async function() {
    await request()
      .get('/api/domain/canary/workflow/open?startTime=2017-11-01')
      .expect(400)

    return request()
      .get('/api/domain/canary/workflow/closed?endTime=2017-11-01')
      .expect(400)
  })
})