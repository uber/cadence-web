...
describe('Workflow History', function() {
  it('should forward the request to the cadence frontend with workflowId and runId', function() {
    ...
    return request()
      .get('/api/domain/canary/workflow/ci%2Fdemo/run1/history')
      .expect(200)
  ...
  it('should forward the nextPageToken', function() {
    ...
    return request()
      .get('/api/domain/canary/workflow/ci%2Fdemo/run1/history?nextPageToken=cGFnZTI%3D')
      .expect(200)
      .expect('Content-Type', /json/)
      .expect({
        archived: null,
  ...
  it('should support long polling by forwarding the waitForNewEvent flag', function() {
    ...
    return request()
      .get('/api/domain/canary/workflow/ci%2Fdemo/run1/history?waitForNewEvent=true')
      .expect(200)
      .expect('Content-Type', /json/)
      .then(() =>  request()
        .get('/api/domain/canary/workflow/ci%2Fdemo/run1/history?waitForNewEvent')
        .expect(200)
      )
  })
  ...
  describe('Export', function() {
    ...
    it('should be able to export history in a format compatible with the CLI', function() {
      ...
      return request()
        .get('/api/domain/canary/workflow/ci%2Fdemo/run1/export')
        .expect(200)
