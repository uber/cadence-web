describe('Workflow Execution', function() {
  it('should describe the workflow', async function () {
    ...
    return request()
      .get('/api/domain/canary/workflow/ci%2Fdemo/run1')
      .expect(200)
  ...
  it('should terminate a workflow', async function() {
    ...
    return request()
      .post('/api/domain/canary/workflow/ci%2Fdemo/run1/terminate')
  ...
  it('should signal a workflow without input', async function() {
    ...
    return request()
      .post('/api/domain/canary/workflow/ci%2Fdemo/run2/signal/firealarm')
      .expect(204)
