describe('Intro', function() {
  it('should provide links to learn about cadence', async function() {
    var testEl = new Scenario(this.test).render(),
        linksEl = await testEl.waitUntilExists('section.intro .links')
  ...
  it('should render the details of a valid domain', async function() {
    ...
    var descriptionEl = await testEl.waitUntilExists('.intro .domain-description')
  ...
  it('should go to the workflows of the domain requested when entered', async function() {
    ...
    var headerBar = testEl.querySelector('header.top-bar')
  ...
  it('should activate the change-domain button when the domain is valid and navigate to it', async function() {
    var [testEl, scenario] = new Scenario(this.test).go(),
        domainNav = await testEl.waitUntilExists('.intro .domain-navigation'),
        domainInput = domainNav.querySelector('input'),
        changeDomain = domainNav.querySelector('a.change-domain')
