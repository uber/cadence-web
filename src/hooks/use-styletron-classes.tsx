...
export type StyletronCSSObjectValue = StyleObject | ((theme: Theme) => StyleObject);
...
export type StyletronCSSObjectOf<CSSObject> = { [K in keyof CSSObject]: StyletronCSSObjectValue };
...
export default function useStyletronClasses<T extends object = StyletronCSSObject>(s: StyletronCSSObjectOf<T>) {
    const [css, theme] = useStyletron();
    const cls = Object.entries<StyletronCSSObjectValue>(s).reduce<ClsObjectFor<T>>((result, [key, styles]) => {
