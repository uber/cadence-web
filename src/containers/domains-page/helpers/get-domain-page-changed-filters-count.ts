import { PageQueryParamValues, PageQueryParams } from "@/hooks/use-page-query-params/use-page-query-params.types";
...
function getDomainsPageChangedFiltersCount(
    ...
    const configsByKey = Object.fromEntries(queryParamsConfig.map((c) => [c.key, c]));
