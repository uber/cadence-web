...
describe('getUniqueDomains', () => {
  it('should return unique domains based on id-name-activeClusterName', () => {
    const domains: DomainData[] = [
      { id: '1', name: 'Domain1', activeClusterName: 'ClusterA', clusters: [{ clusterName: 'clusterA' }, { clusterName: 'clusterB' }] },
      { id: '2', name: 'Domain2', activeClusterName: 'ClusterB', clusters: [{ clusterName: 'clusterA' }, { clusterName: 'clusterB' }] },
